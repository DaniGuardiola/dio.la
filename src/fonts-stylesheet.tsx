export const fontsStyleSheet = `
/* Inter font - https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap */
...
/* Roboto font - https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400;700&family=Roboto+Slab&display=swap */
