...
> **Important note:** we're talking about **JavaScript lexical scope**, which is entirely unrelated to _Lexical_. I know, it's confusing. 😅
>
...
Understanding how updates work in Lexical has been very important for me.

When I started building with Lexical, things like the `$` function prefix seemed scary and opaque at first. Not being certain about when or how updates are applied left me in the dark. But once I understood, I could use this knowledge to my advantage. And when bugs arose, finding and fixing the root cause became much easier.
