...
description: Using :has() to finally solve a decades-long CSS limitation.
topics:
  - css
  - frontend
---
...
Many thanks to [Bill Criswell](https://twitter.com/crswll) for posting the initial idea and [the ensuing discussion on Twitter](https://twitter.com/crswll/status/1621588302145937410)!
