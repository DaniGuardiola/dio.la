...
I'm talking about the **open/closed** pattern, as coined by [Diego Haz](https://twitter.com/diegohaz) (author of [Ariakit](https://ariakit.org/)), who introduced this concept in [this Twitter thread](https://twitter.com/diegohaz/status/1305450112890662914).
...
> Note that these two examples are simplified and incomplete. I go into more detail on these topics later in the article.
