...
description: Misusing the radix parameter for evil purposes is easy and fun... and it can go wrong!
topics:
  - js
  - fun
draft: true
...
Alright so hear me out. The ID trick was just a warm-up. It's pretty cool, but now we're gonna amp up the nerdiness to 11. Sorry not sorry.

This is a trick of my own, and it's probably been done before, but I couldn't find it anywhere else (there are probably better ways to do this too!). It's also worth noting that I probably wouldn't have thought of it if I didn't know about the ID trick.
...
<p class="h-[100rem] flex justify-center items-center font-bold text-xl">
  ⚠️  Spoilers ahead ⚠️ 
</p>

HI AGAIN!!1 I already thought you were never coming back, _phew_! 😅

Alright, let's do the reveal. Check out the digits I highlighted:
...
1. Welcome to my list.
     ...
     a. It's definitely a list.
     b. It has many items.
     ...
     y. Wow!
     z. Such item!
    ba. Many list!
    bb. Co-co-co-combo breaker!

2. More stuff here, idk.
3. K bye.
```
...
```
 ...
 2. You really don't have anything better to do?
 ...
 8. I'm bored.
 9. Copilot wrote some of these items for me lol.
20. Wtf, 20?!?
21. I'm out.
```

In reality, mathematically speaking, we haven't skipped anything. But it still feels wrong, so we don't jump to `ba` after `z`. We jump to `aa` instead.
